...
<dl>
<dt class="update"><?php echo _("December 17, 2014"); ?></dt><dd><?php echo ("Improvements: Added a Countries layer to toggle international borders. Requested by Yossef Rapoport.")?></dd>
