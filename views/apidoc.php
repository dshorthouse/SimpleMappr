...
<div id="map-api">
  ...
  <dl>
    ...
    <span class="api-example"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/public/files/demo.txt">Example file</a></span>
    ...
    <dt>shape[x]</dt>
    <dd><?php echo _("shape of marker for column x; options are plus, cross, asterisk, circle, square, triangle, star, hexagon, opencircle, opensquare, opentriangle, openstar, openhexagon"); ?> <span class="api-example"><em>e.g.</em> shape[0]=circle</span></dd>
