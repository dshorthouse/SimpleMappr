...
<p class="update"><strong>October 19, 2011</strong><span>Improvements: legend appearance in downloads and API. Bug fixes: proper rendering of Point Data/Regions layers after one or more were removed; proper border on download when the map is rotated; improved behaviour of crop when map loaded.</span></p>
