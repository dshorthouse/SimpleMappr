...
<div id="map-api">
	<div id="general-api" class="panel">
		<p>A simple, restful API may be used with Internet accessible, tab-separated text files with additional parameters outlined below.</p>
	</div>
	...
	<dl>
		...
		<dt>projection</dt>
		<dd>the output projection in either EPSG or ESRI references. See <a href="http://spatialreference.org/">http://spatialreference.org/</a> for spatial references. Accepted projections are: <?php foreach(MAPPR::$_accepted_projections as $key => $value) { print $key . ' (=' . $value . '), '; } ?><em>e.g. projection=esri:102009</em></dd>
