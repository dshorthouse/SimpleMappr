...
class CoordinateConversionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $coord = "-45d.4dt5;0dds";
        $clean = \SimpleMappr\Utilities::cleanCoord($coord);
    ...
    public function test_check_on_earth_invalid()
    {
        ...
        $coord->x = -133;
        $coord->y = 5543;
        $checked = \SimpleMappr\Utilities::onEarth($coord);
    ...
    {
        $coord = "52° 32' 25\" N,";
        $dd = \SimpleMappr\Utilities::makeCoordinates($coord);
    ...
    {
        $dms = "45d53'25\"W";
        $dd = \SimpleMappr\Utilities::dmsToDeg($dms);
