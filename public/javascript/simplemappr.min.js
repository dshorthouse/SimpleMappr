...
i=b.pix2geo(h);j=b.pix2geo(k);$("#jcrop-coord-ul").val(i.x+", "+i.y);$("#jcrop-coord-lr").val(j.x+", "+j.y);$("#jcrop-dimension-w").val(g);$("#jcrop-dimension-h").val(a);$("#jcrop-dimension-wrapper").css({left:g/2-$("#jcrop-dimension-wrapper").width()/2,top:a/2-$("#jcrop-dimension-wrapper").height()/2});$.cookie("jcrop_coords",'{ "jcrop_coord_ul" : "'+$("#jcrop-coord-ul").val()+'", "jcrop_coord_lr" : "'+$("#jcrop-coord-lr").val()+'" }');$(".jcrop-coord").blur(function(){b.vars.cropUpdated||(b.vars.cropUpdated=
b.updateCropCoordinates())}).keypress(function(a){var c=a.keyCode||a.which;if(13===c||9===c)a.preventDefault(),b.vars.cropUpdated=!1,this.blur()});$(".jcrop-dimension").blur(function(){b.vars.cropUpdated||(b.vars.cropUpdated=b.updateCropDimensions())}).keypress(function(a){var c=a.keyCode||a.which;if(13===c||9===c)a.preventDefault(),b.vars.cropUpdated=!1,this.blur()});$("span","#scale-measure").text(l*g+" X "+l*a).parent().show();break;case "zoom":$(".jcrop-holder div:first").css("backgroundColor",
...
{addClass:"customJzoom",bgOpacity:1,bgColor:"white",onChange:a.bindCallback(a,a.showCoords),onSelect:a.bindCallback(a,a.showCoords)});$(".jcrop-tracker").mousedown(function(){a.activateJcrop("zoom")})},initJquery:function(){var a=this,b=this.vars;a.destroyJcrop();a.resetJbbox();b.jCropType="query";b.jqueryAPI=$.Jcrop("#mapOutputImage",{addClass:"customJzoom",bgOpacity:1,bgColor:"white",onChange:a.bindCallback(a,a.showCoords),onSelect:a.bindCallback(a,a.showCoords)});$(".jcrop-tracker").mousedown(function(){a.activateJcrop("query")})},
activateJcrop:function(a){switch(a){case "zoom":$(document).bind("mouseup",this,this.aZoom);break;case "query":$(document).bind("mouseup",this,this.aQuery)}},aZoom:function(a){a=a.data;a.destroyRedo();a.showMap();$(document).unbind("mouseup",a.aZoom)},dblclickZoom:function(a,b){var c=0,d=0,d={},d=$(a).offset(),c=b.pageX-d.left,d=b.pageY-d.top;$("#bbox_rubberband").val(c+","+d+","+c+","+d);this.destroyRedo();this.showMap()},aQuery:function(a){var b=a.data,c=b.vars.fillColor.r+" "+b.vars.fillColor.g+
" "+b.vars.fillColor.b,a={bbox:$("#rendered_bbox").val(),bbox_query:$("#bbox_query").val(),projection:$("#projection").val(),projection_map:$("#projection_map").val(),origin:$("#origin").val(),qlayer:$("#stateprovince").prop("checked")?"stateprovinces_polygon":"base",width:$('input[name="width"]').val(),height:$('input[name="height"]').val()};$(document).unbind("mouseup",b.aQuery);b.destroyJcrop();b.destroyRedo();b.showSpinner();$.ajax({type:"POST",url:b.settings.baseUrl+"/query/",data:a,timeout:3E4,
success:function(a){if(0<a.length){var e=a.map(function(a){return a}).join(", "),f=$(".fieldset-regions").length;$.each($(".fieldset-regions"),function(a){a===f-1&&!$('button[data-type="regions"]').prop("disabled")&&(b.addAccordionPanel("regions"),f+=1);if(""===$('input[name="regions['+a+'][title]"]').val()||""===$('textarea[name="regions['+a+'][data]"]').val())return $('input[name="regions['+a+'][title]"]').val("Selected Region "+(a+1).toString()),$('input[name="regions['+a+'][color]"]').val(c),
$('textarea[name="regions['+a+'][data]"]').val(e),0<a&&$("#fieldSetsRegions").accordion("activate",a),!1});b.showMap()}else b.hideSpinner()},error:function(a,c){"timeout"===c&&b.hideSpinner()}})},textareaCounter:function(a,b){var c=this.vars;switch(b){case "get":switch(a){case "coords":return c.newPointCount;case "regions":return c.newRegionCount}break;case "increase":switch(a){case "coords":return c.newPointCount+=1,c.newPointCount;case "regions":return c.newRegionCount+=1,c.newRegionCount}break;
case "decrease":switch(a){case "coords":return c.newPointCount-=1,c.newPointCount;case "regions":return c.newRegionCount-=1,c.newRegionCount}}},addAccordionPanel:function(a){var b=this,c=b.textareaCounter(a,"get"),d=$(".addmore[data-type='"+a+"']"),e={},f="coords"===a?"0 0 0":"150 150 150",g=0,h=[];d.attr("data-type")===a&&(c<b.settings.maxTextareaCount&&(d.parent().prev().accordion("activate",!1),e=d.parent().prev().children("div:last").clone(),g=parseInt(e.find("h3 a").text().split(" ")[1],10),
c=b.textareaCounter(a,"increase"),e.find("h3 a").text(e.find("h3 a").text().split(" ")[0]+" "+(g+1).toString()),e.find("input.m-mapTitle").attr("name",a+"["+g.toString()+"][title]").val(""),e.find("textarea").attr("name",a+"["+g.toString()+"][data]").removeClass("textarea-processed").val("").each(function(){b.addGrippies(this)}),e.find("select.m-mapShape").attr("name",a+"["+g.toString()+"][shape]").val("circle"),e.find("select.m-mapSize").attr("name",a+"["+g.toString()+"][size]").val("10"),e.find("input.colorPicker").attr("name",
...
b.removeAccordionPanel(e,a);c=b.textareaCounter(a,"decrease")}).parent().find("button.clearself").click(function(a){a.preventDefault();b.clearSelf($(this))}).parent().parent().find(".ui-icon:last").remove()}),d.parent().prev().accordion("destroy").accordion({header:"h3",collapsible:!0,autoHeight:!1,active:!1}),"regions"===a&&b.bindAutocomplete()),c>=b.settings.maxTextareaCount-3&&d.prop("disabled",!0))},removeAccordionPanel:function(a,b){var c=$(".addmore[data-type='"+b+"']");a.nextAll().each(function(){var a=
...
b+"["+(a-2).toString()+"][color]")});a.remove();c.prop("disabled",!1)},addGrippies:function(a){function b(a){d.height(Math.max(32,e+a.pageY)+"px");return!1}function c(){$(document).unbind("mousemove",b).unbind("mouseup",c);d.css("opacity",1)}var d=$(a).addClass("textarea-processed"),e=null;$(a).parent().find(".grippie").bind("mousedown",function(a){e=d.height()-a.pageY;d.css("opacity",0.25);$(document).bind("mousemove",b).bind("mouseup",c);return!1})},bindAddButtons:function(){var a=this;$(".addmore").click(function(b){var c=
$(this).attr("data-type"),d=0;b.preventDefault();a.addAccordionPanel(c);d=$(this).parent().prev().children().length;$(this).parent().prev().accordion("activate",d-1);return!1})},loadMapList:function(a){var b=this,c=a||{},d={};$("#usermaps").html("");b.showSpinner();d={locale:b.getParameterByName("locale"),search:c.search?encodeURIComponent(c.search.toLowerCase()):null,uid:c.uid||null};c.sort&&(d.sort=c.sort.item,d.dir=c.sort.dir);d.locale||delete d.locale;d.search||delete d.search;d.uid||delete d.uid;
$.ajax({type:"GET",url:b.settings.baseUrl+"/usermap/",data:d,dataType:"html",success:function(a){if(a.indexOf("session timeout")!==-1)window.location.reload();else{$("#usermaps").html(a);b.hideSpinner();$(".toolsRefresh",".grid-usermaps").click(function(a){a.preventDefault();b.loadMapList()});$("#filter-mymaps").val(c.search).keypress(function(a){if(a.which===13){a.preventDefault();d.search=$(this).val();b.loadMapList(d);b.trackEvent("maplist","filter")}}).focus();$(".ui-icon-triangle-sort",".grid-usermaps").click(function(a){a.preventDefault();
d.sort={item:$(this).attr("data-sort"),dir:"asc"};if($(this).hasClass("asc"))d.sort.dir="desc";b.loadMapList(d);b.trackEvent("maplist","sort")});$(".map-load").click(function(a){a.preventDefault();b.loadMap(this);b.trackEvent("map","load")});$(".map-delete").click(function(a){a.preventDefault();b.deleteMapConfirmation(this)})}}})},removeExtraElements:function(){var a=this;$.each($(".fieldset-points"),function(b){2<b&&($("#fieldSetsPoints div.fieldset-points:eq("+b.toString()+")").remove(),a.vars.newPointCount=
0)});$.each($(".fieldset-regions"),function(b){2<b&&($("#fieldSetsRegions div.fieldset-regions:eq("+b.toString()+")").remove(),a.vars.newRegionCount=0)})},prepareInputs:function(a){var b={},c=[],b={status:"ok",mid:$(".map-embed").attr("data-id"),map:a};b.map.coords=b.map.coords||[];b.map.regions=b.map.regions||[];b.map.layers=b.map.layers||{};b.map.options=b.map.options||{};String.prototype.clean=function(){return this.replace(/[\[\]]/g,"")};$.each(a,function(a,e){if(-1!==a.indexOf("coords")&&(c=
a.match(/\[[A-Za-z0-9]*?\]/g)))void 0===b.map.coords[parseInt(c[0].clean(),10)]&&(b.map.coords[parseInt(c[0].clean(),10)]={}),b.map.coords[parseInt(c[0].clean(),10)][c[1].clean()]=e,delete b.map["coords"+c[0]+c[1]];if(-1!==a.indexOf("regions")&&(c=a.match(/\[[A-Za-z0-9]*?\]/g)))void 0===b.map.regions[parseInt(c[0].clean(),10)]&&(b.map.regions[parseInt(c[0].clean(),10)]={}),b.map.regions[parseInt(c[0].clean(),10)][c[1].clean()]=e,delete b.map["regions"+c[0]+c[1]];if(-1!==a.indexOf("layers")&&(c=a.match(/\[[A-Za-z0-9]*?\]/g)))b.map.layers[c[0].clean()]=
e,delete b.map["layers"+c[0]];if(-1!==a.indexOf("options")&&(c=a.match(/\[[A-Za-z0-9]*?\]/g)))b.map.options[c[0].clean()]=e,delete b.map["options"+c[0]];"save[title]"===a&&(b.map.save={title:e},delete b.map["save[title]"]);"gridspace"===a&&(b.map.grid_space=e);"download-filetype"===a&&(b.map.download_filetype=e);"download-factor"===a&&(b.map.download_factor=e)});return b},loadInputs:function(a){var b=$("#filter-mymaps").val();this.removeExtraElements();$("#form-mapper").clearForm();$.each(["width",
"height"],function(){$('input[name="'+this+'"]').val($('input[name="'+this+'"]').val())});$(".addmore").prop("disabled",!1);$("#filter-mymaps").val(b);$("#origin-selector").hide();this.loadCoordinates(a);this.loadRegions(a);this.loadLayers(a);this.loadSettings(a)},loadMap:function(a){var b=this,c=$(a).attr("data-id");this.tabSelector(0);this.showSpinner();$.ajax({type:"GET",url:b.settings.baseUrl+"/usermap/"+c,dataType:"json",timeout:3E4,success:function(a){b.hideSpinner();"ok"===a.status?(b.loadInputs(a),
b.showMap(a),b.bindStorage(),b.activateEmbed(c)):b.showErrorMessage($("#mapper-loading-error-message").text());b.toggleUndo();b.toggleRedo()},error:function(a,c){"timeout"===c&&b.showErrorMessage($("#mapper-loading-error-message").text())}})},loadSettings:function(a){var b="",b="",b=a.map.save.title;$('input[name="save[title]"]').val(b);$(".m-mapSaveTitle").val(b);$("#mapTitle").text(b);b=b.replace(/[?*:;{}\\ "']+/g,"_");$("#file-name").val(b);$("#projection").val(a.map.projection);this.vars.origins.hasOwnProperty($("#projection").val())&&
$("#origin-selector").show();$.each(["bbox_map","projection_map","rotation","origin"],function(){$('input[name="'+this+'"]').val(a.map[this])});a.map.origin||$("#origin").val(this.vars.origins[$("#projection").val()]);$('input[name="border_thickness"]').val(1.25);$("#border-slider").slider({value:1.25});void 0!==a.map.border_thickness&&a.map.border_thickness&&($('input[name="border_thickness"]').val(a.map.border_thickness),$("#border-slider").slider({value:a.map.border_thickness}));this.setRotation(a.map.rotation);
this.resetJbbox();$.each(["border","legend","scalebar","scalelinethickness"],function(){$("#"+this).prop("checked",false);$('input[name="options['+this+']"]').val("")});void 0!==a.map.options&&$.each(["border","legend","scalebar","scalelinethickness"],function(){if(a.map.options[this]&&a.map.options[this]!==void 0){$("#"+this).prop("checked",true);$('input[name="options['+this+']"]').val(1)}});void 0!==a.map.download_factor&&a.map.download_factor?($('input[name="download_factor"]').val(a.map.download_factor),
$("#download-factor-"+a.map.download_factor).prop("checked",!0)):$("#download-factor-3").prop("checked",!0);void 0!==a.map.download_filetype&&a.map.download_filetype?($('input[name="download_filetype"]').val(a.map.download_filetype),b=$("#download-"+a.map.download_filetype).prop("checked",!0),this.toggleFileType(b)):$("#download-svg").prop("checked",!0);void 0!==a.map.grid_space&&a.map.grid_space?($('input[name="gridspace"]').prop("checked",!0),$("#gridspace-"+a.map.grid_space).prop("checked",!0)):
$("#gridspace").prop("checked",!0);void 0!==a.map.gridlabel&&a.map.gridlabel?$('input[name="gridlabel"]').prop("checked",!0).val("false"):$("#gridlabel").prop("checked",!0)},loadCropSettings:function(a){var b=[];a.map.bbox_rubberband?(b=a.map.bbox_rubberband.split(","),this.initJcrop([b[2],b[3],b[0],b[1]]),this.toggleFileFactor(a.map.download_factor)):this.destroyJcrop()},loadShapeSize:function(a,b){$.each(["shape","size"],function(){""===b[a][this].toString()?$('select[name="coords['+a.toString()+
"]["+this+']"]')[0].selectedIndex=3:$('select[name="coords['+a.toString()+"]["+this+']"]').val(b[a][this])})},loadCoordinates:function(a){var b=this,c=a.map.coords||[],d="",e="",f="",g=/[?*{}\\]+/g;$.each(c,function(a){2<a&&b.addAccordionPanel("coords");d=c[a].title||"";e=c[a].data.replace(g,"")||"";f=c[a].color||"0 0 0";$('input[name="coords['+a.toString()+'][title]"]').val(d);$('textarea[name="coords['+a.toString()+'][data]"]').val(e);b.loadShapeSize(a,c);$('input[name="coords['+a.toString()+'][color]"]').val(f)})},
loadRegions:function(a){var b=this,c=a.map.regions||[],d="",e="",f="";$.each(c,function(a){2<a&&b.addAccordionPanel("regions");d=c[a].title||"";e=c[a].data||"";f=c[a].color||"150 150 150";$('input[name="regions['+a.toString()+'][title]"]').val(d);$('textarea[name="regions['+a.toString()+'][data]"]').val(e);$('input[name="regions['+a.toString()+'][color]"]').val(f)})},loadLayers:function(a){a.map.layers&&$.each(a.map.layers,function(a){console.log(a);$('input[name="layers['+a+']"]').prop("checked",
!0)})},activateEmbed:function(a){var b=this,c=["img","kml","svg","json"];$(".map-embed").attr("data-id",a).css("display","block").click(function(d){d.preventDefault();$.each(c,function(){"img"===this.toString()?$("#embed-"+this,"#mapEmbed").val('<img src="'+b.settings.baseUrl+"/map/"+a+'" alt="" />'):$("#embed-"+this,"#mapEmbed").val(b.settings.baseUrl+"/map/"+a+"."+this)});$("#mapEmbed").find("span.mid").text(a).end().dialog({width:"525",dialogClass:"ui-dialog-title-mapEmbed",autoOpen:!0,modal:!0,
closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){$(this).dialog("destroy")}}]}).show()})},deleteMapConfirmation:function(a){var b=this,c=$(a).attr("data-id"),a="<em>"+$(a).parent().parent().find(".title").text()+"</em>";$("#mapper-message-delete").find("span").html(a).end().dialog({height:"250",width:"500",dialogClass:"ui-dialog-title-mapper-message-delete",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:$("#button-titles span.delete").text(),
"class":"negative",click:function(){$.ajax({type:"DELETE",url:b.settings.baseUrl+"/usermap/"+c,success:function(){b.loadMapList();b.trackEvent("map","delete")}});$(this).dialog("destroy")}},{text:$("#button-titles span.cancel").text(),"class":"ui-button-cancel",click:function(){$(this).dialog("destroy")}}]}).show()},loadUserList:function(a){var b=this,a=a||{},c={locale:this.getParameterByName("locale")};b.showSpinner();a.sort&&(c.sort=a.sort.item,c.dir=a.sort.dir);c.locale||delete c.locale;$.ajax({type:"GET",
url:b.settings.baseUrl+"/user/",data:c,dataType:"html",success:function(a){if(a.indexOf("access denied")!==-1)window.location.reload();else{$("#userdata").html(a);b.hideSpinner();$(".toolsRefresh",".grid-users").click(function(a){a.preventDefault();b.loadUserList()});$(".ui-icon-triangle-sort",".grid-users").click(function(a){a.preventDefault();c.sort={item:$(this).attr("data-sort"),dir:"asc"};if($(this).hasClass("asc"))c.sort.dir="desc";b.loadUserList(c)});$(".user-delete").click(function(a){a.preventDefault();
b.deleteUserConfirmation(this)});$(".user-load").click(function(a){a.preventDefault();b.loadMapList({uid:$(this).attr("data-uid")});b.tabSelector(3)})}}})},getLanguage:function(){var a="",b=this.getParameterByName("locale");if("fr_FR"===b||"es_ES"===b)a="?locale="+b;return a},deleteUserConfirmation:function(a){var b=this,c=$(a).attr("data-id"),a="<em>"+$(a).parent().parent().children("td:first").text()+"</em>";$("#mapper-message-delete").find("span").html(a).end().dialog({height:"250",width:"500",
dialogClass:"ui-dialog-title-mapper-message-delete",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:$("#button-titles span.delete").text(),"class":"negative",click:function(){$.ajax({type:"DELETE",url:b.settings.baseUrl+"/user/"+c,success:function(){b.loadUserList();b.trackEvent("user","delete")}});$(this).dialog("destroy")}},{text:$("#button-titles span.cancel").text(),"class":"ui-button-cancel",click:function(){$(this).dialog("destroy")}}]}).show()},bindSave:function(){var a=
this;$(".map-save").click(function(b){b.preventDefault();a.mapSave()})},mapSave:function(){var a=!1,b=/[?*:;{}\\ "'\/@#!%\^()<>.]+/g,c="",d=this;$("#mapSave").dialog({autoOpen:!0,height:"175",width:"350",dialogClass:"ui-dialog-title-mapSave",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:$("#button-titles span.save").text(),"class":"positive",click:function(){""===$.trim($(".m-mapSaveTitle").val())&&(a=!0);a?$(".m-mapSaveTitle").addClass("ui-state-error").keyup(function(){$(this).removeClass("ui-state-error")}):
...
!1;$(this).removeClass("ui-state-error")});$(this).val()&&""===$(b).val()&&(c=!0,$(b).addClass("ui-state-error"))});c?a.showMessage($("#mapper-missing-legend").text()):(a.destroyRedo(),a.showMap(),a.tabSelector(0))})},mapToggleSettings:function(){$("#mapToolsCollapse a").trigger("click")},bindPanelToggle:function(){var a=this;$("#mapToolsCollapse a").tipsy({gravity:"e"}).toggleClick(function(b){b.preventDefault();$("#mapOutputImage").attr("width",0).attr("height",0);$("#mapOutputScale").hide();$(this).parent().addClass("mapTools-collapsed");
...
function(){$('input[name="width"]').val(800);a.mapRefresh()})})})},showMessage:function(a){$("#mapper-message").html(a).dialog({autoOpen:!0,height:"200",width:"400",dialogClass:"ui-dialog-title-mapper-message",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){$(this).dialog("destroy")}}]}).show()},drawLegend:function(){var a=$("#legend_url").val(),b=$("#mapLegend");a?b.html('<img src="'+a+'" />'):b.html("<p><em>"+$("#mapper-legend-message").text()+
"</em></p>")},drawScalebar:function(){$("#mapScale img").attr("src",$("#scalebar_url").val()).show()},showBadPoints:function(){var a=$("#bad_points").val();a&&($("#badRecords").html(a),$("#badRecordsWarning").show())},showSpinner:function(){$(".mapper-loading-spinner").show()},hideSpinner:function(){$(".mapper-loading-spinner").hide()},showErrorMessage:function(a){$("#mapOutput").append('<span class="mapper-message-error ui-corner-all ui-widget-content">'+a+"</span>")},hideErrorMessage:function(){$("#mapOutput .mapper-message-error").remove()},
showMap:function(a){var b=(new Date).getTime(),c="",d={};this.destroyJcrop();$("#output").val("pnga");$("#badRecordsWarning").hide();$("#download_token").val(b);this.showSpinner();c=$("form").serialize();d=$("form").serializeJSON();this.postData(c,a);$.jStorage.set("do-"+b.toString(),d);this.toggleUndo(!0)},postData:function(a,b){var c=this;c.hideErrorMessage();$.ajax({type:"POST",url:c.settings.baseUrl+"/application/",data:a,dataType:"json",timeout:3E4,success:function(a){c.resetFormValues(a);c.resetJbbox();
c.drawMap(a,b);c.drawLegend();c.drawScalebar();c.showBadPoints();c.addBadRecordsViewer()},error:function(a,b){"timeout"===b&&(c.showErrorMessage($("#mapper-loading-error-message").text()),c.hideSpinner())}})},resetFormValues:function(a){$("#mapOutput input").each(function(){$(this).val("")});$.each("rendered_bbox rendered_rotation rendered_projection legend_url scalebar_url bad_points".split(" "),function(){$("#"+this).val(a[this])});$("#bbox_map").val($("#rendered_bbox").val());$("#projection_map").val($("#rendered_projection").val());
$("#rotation").val($("#rendered_rotation").val());$("#pan").val("")},drawMap:function(a,b){var c=this;$("#mapOutputImage").attr("width",a.size[0]).attr("height",a.size[1]).attr("src",a.mapOutputImage).one("load",function(){b||(b={map:{bbox_rubberband:""}});c.loadCropSettings(b);c.hideSpinner()})},addBadRecordsViewer:function(){var a=this;$("#badRecordsViewer").dialog({autoOpen:!1,height:"200",width:"500",dialogClass:"ui-dialog-title-badRecordsViewer",position:[200,200],modal:!0,closeOnEscape:!1,draggable:!0,
resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){$(this).dialog("destroy")}}]});$(".toolsBadRecords").click(function(b){b.preventDefault();a.addBadRecordsViewer();$("#badRecordsViewer").dialog("open")})},generateDownload:function(){var a=this,b=$("#file-name").val(),c=(new Date).getTime().toString(),d="",e="",f="png",b=b.replace(/[~$?*,:;{}\[\]\\ "'\/@#!%\^()<>.+=|`&]+/g,"_");$("#file-name").val(b);$('input[name="file_name"]').val(b);$('input[name="download_factor"]').val($('input[name="download-factor"]:checked').val());
f=$("input[name='download-filetype']:checked").val();a.setFormOptions();$("#download_token").val(c);$.each(["ui-dialog-buttonpane","download-dialog"],function(){$("."+this).hide()});$(".download-message").show();switch(f){case "pptx":$("#output").val("pptx");a.vars.jcropAPI?$("#crop").val(1):a.resetJbbox();e=$("form").serialize();$("body").download("/pptx/"+a.getLanguage(),e,"post");$("#output").val("pnga");break;case "docx":$("#output").val("docx");a.vars.jcropAPI?$("#crop").val(1):a.resetJbbox();
e=$("form").serialize();$("body").download("/docx/"+a.getLanguage(),e,"post");$("#output").val("pnga");break;case "kml":e=$("form").serialize();$("body").download("/kml/",e,"post");break;default:$("#download").val(1),$("#output").val(f),a.vars.jcropAPI?$("#crop").val(1):a.resetJbbox(),e=$("form").serialize(),$("body").download("/application/",e,"post"),$("#download").val(""),$("#output").val("pnga")}a.vars.fileDownloadTimer=window.setInterval(function(){d=$.cookie("fileDownloadToken");d===c&&a.finishDownload()},
1E3);a.trackEvent("download",f)},setFormOptions:function(){$.each(["border","legend","scalebar","scalelinethickness"],function(){$("#"+this).prop("checked")?$('input[name="options['+this+']"]').val(1):$('input[name="options['+this+']"]').val("")})},finishDownload:function(){$(".download-message").hide();$.each(["download-dialog","ui-dialog-buttonpane"],function(){$("."+this).show()});window.clearInterval(this.vars.fileDownloadTimer);$.cookie("fileDownloadToken",null)},showExamples:function(){$("#mapper-message-help").html('<img src="public/images/help-data.png" alt="" />').dialog({height:"355",
width:"525",dialogClass:"ui-dialog-title-mapper-message-help",autoOpen:!0,modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){$(this).dialog("destroy")}}]}).show()},showCodes:function(){var a=this.getParameterByName("locale")?{locale:this.getParameterByName("locale")}:{};$("#mapper-message-codes").dialog({height:"450",width:"850",dialogClass:"ui-dialog-title-mapper-message-codes",autoOpen:!0,modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,
buttons:[{text:"OK","class":"positive",click:function(){$(this).dialog("destroy")}}]}).show();this.loadCodes($("#mapper-message-codes"),a)},loadCodes:function(a,b){var c=this,d="";a.find("tbody tr td").text("\u00a0");a.find("tbody tr td:first").text("\u00a0\u00a0\u00a0").addClass("loading");$.ajax({type:"GET",url:c.settings.baseUrl+"/places/",data:b,dataType:"html",success:function(e){a.html(e);d=a.find(".filter-countries");d.val("");void 0!==b.filter&&d.val(b.filter);d.keypress(function(e){var g=
e.keyCode||e.which;if(13===g||9===g)e.preventDefault(),b.filter=d.val(),c.loadCodes(a,b)});d.blur(function(){b.filter=d.val();c.loadCodes(a,b)})}})},performRotation:function(a){$("#rotation").val($(a).attr("data-rotate"));this.resetJbbox();this.destroyRedo();this.showMap();this.trackEvent("rotate",$(a).attr("data-rotate"))},setRotation:function(a){var b=$("#mapControls"),c=$(".thumb",b),d=$(".overview",b).children(),e=0,f=e=0;a||(a=0);a=0>parseFloat(a)?parseFloat(a)+360:parseFloat(a);e=a*(Math.PI/
180);$(".overview",b).css("left",-(a/360*d.outerWidth(!0)*d.length)+"px");f=Math.round(28*-Math.cos(e)+(b.outerHeight()/2-c.outerHeight()/2))+"px";e=Math.round(28*Math.sin(e)+(b.outerWidth()/2-c.outerWidth()/2))+"px";$(".thumb",b).css("top",f).css("left",e)},getParameterByName:function(a){a="[\\?&]"+a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]")+"=([^&#]*)";a=RegExp(a).exec(window.location.href);return null===a?"":decodeURIComponent(a[1].replace(/\+/g," "))},mapCircleSlider:function(){for(var a=0,
b="",a=0;360>a;a+=1)0===a%5&&(b+='<li data-rotate="'+a+'"></li>');return b},clearStorage:function(){this.destroyRedo();$.jStorage.flush()},bindStorage:function(){var a={},b=(new Date).getTime();this.clearStorage();a=$("form").serializeJSON();$.jStorage.set("do-"+b.toString(),a)},bindRotateWheel:function(){var a=this;$(".overlay","#mapControls").css("background-image",'url("public/images/bg-rotatescroll.png")');$(".overview","#mapControls").append(a.mapCircleSlider());$("#mapControls").tinycircleslider({snaptodots:!0,
radius:28,callback:function(b){$(".mapper-loading-spinner").prop("hidden")&&a.performRotation(b)}})},bindTabs:function(){var a=$("#tabs"),b="";$("#mapTools").tabs({selected:0});a.tabs({cache:!0,load:function(a,b){$(b.tab).data("cache.tabs",""===$(b.panel).html()?!1:!0)},event:"change"}).find(".ui-state-disabled").each(function(){$(this).removeClass("ui-state-disabled")}).end().show();a.find("ul.navigation a").click(function(){var a={},d=$(this).parent().prevAll().length;a.tabs=d;$.bbq.pushState(a);
$.each($("#site-languages a"),function(){b=$(this).attr("href").split("#")[0];$(this).attr("href",b+"#tabs="+d)})});$(window).bind("hashchange",function(){var c=$.bbq.getState("tabs",!0)||0;a.find("ul.navigation a").eq(c).triggerHandler("change");$.each($("#site-languages a"),function(){b=$(this).attr("href").split("#")[0];$(this).attr("href",b+"#tabs="+c)})});$(window).trigger("hashchange")},screenSizeListener:function(){var a=this;$(window).resize(function(){var b=a.getPageSize(),c=a.getPageScroll();
$("#mapper-overlay").css({width:b[0],height:b[1]});$("#mapper-message").css({top:c[1]+b[3]/10,left:c[0],position:"fixed",zIndex:1001,margin:"0px auto",width:"100%"})})},init:function(){var a=this;this.screenSizeListener();this.bindRotateWheel();this.hideSpinner();$("#header>div").show();this.bindTabs();$("#mapOutput").append('<img id="mapOutputImage" src="public/images/basemap.png" alt="" width="800" height="400" />').find("span.mapper-loading-message").remove();$("#mapScale").append('<img id="mapOutputScale" src="public/images/basemap-scalebar.png" width="200" height="27" />');
...
this.bindAutocomplete();this.bindSave();this.bindDownload();this.bindSubmit();this.bindPanelToggle();$(".toolsUndoDisabled").click(!1);$(".toolsRedoDisabled").click(!1);$("textarea.resizable:not(.textarea-processed)").TextAreaResizer();0<$("#usermaps").length&&(this.loadMapList(),this.tabSelector(3));0<$("#userdata").length&&(this.loadUserList(),this.tabSelector(4));$("input").keypress(function(a){if(a.which===13)return false})}};SimpleMappr.init()});
