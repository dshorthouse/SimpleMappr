...
c.updateCropCoordinates())}).keypress(function(a){var b=a.keyCode||a.which;if(13===b||9===b)a.preventDefault(),c.vars.cropUpdated=!1,this.blur()});a(".jcrop-dimension").blur(function(){c.vars.cropUpdated||(c.vars.cropUpdated=c.updateCropDimensions())}).keypress(function(a){var b=a.keyCode||a.which;if(13===b||9===b)a.preventDefault(),c.vars.cropUpdated=!1,this.blur()});a("span","#scale-measure").text(p*l+" X "+p*b).parent().show();break;case "zoom":a(".jcrop-holder div:first").css("backgroundColor",
"white");a("#bbox_rubberband").val(d+","+e+","+f+","+k);break;case "query":a("#bbox_query").val(d+","+e+","+f+","+k)}},updateCropDimensions:function(){var b=a("#bbox_rubberband").val().split(","),c=parseFloat(b[2])-parseFloat(b[0]),d=parseFloat(b[3])-parseFloat(b[1]),e=a("#mapOutputImage").width(),f=a("#mapOutputImage").height(),k=a("#jcrop-dimension-w").val(),l=a("#jcrop-dimension-h").val(),g=b[0],h=b[2],n=b[1],m=b[3],k=k>e?e:(c-k)/2,l=l>f?f:(d-l)/2,g=parseFloat(b[2])-k,h=parseFloat(b[0])+k,n=parseFloat(b[1])+
l,m=parseFloat(b[3])-l;k>=e&&(g=0,h=e);l>=f&&(n=0,m=f);this.loadCropSettings({map:{bbox_rubberband:g.toString()+","+n.toString()+","+h.toString()+","+m.toString()}});return!0},updateCropCoordinates:function(){var b=[],b={},c=[],c={},b=a("#jcrop-coord-ul").val().split(","),b=this.geo2pix({x:a.trim(b[0]),y:a.trim(b[1])}),c=a("#jcrop-coord-lr").val().split(","),c=this.geo2pix({x:a.trim(c[0]),y:a.trim(c[1])});a.cookie("jcrop_coords",'{ "jcrop_coord_ul" : "'+a("#jcrop-coord-ul").val()+'", "jcrop_coord_lr" : "'+
