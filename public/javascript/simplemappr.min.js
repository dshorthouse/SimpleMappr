...
250);a("#map").animate({width:"800px"},250,function(){a('input[name="width"]').val(800);b.mapRefresh()})})})},showMessage:function(b){a("#mapper-message").html(b).dialog({autoOpen:!0,height:"200",width:"400",dialogClass:"ui-dialog-title-mapper-message",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){a(this).dialog("destroy")}}]}).show()},drawLegend:function(){var b=a("#legend_url").val(),c=a("#mapLegend");b?c.html('<img src="'+b+'" />'):
c.html("<p><em>"+a("#mapper-legend-message").text()+"</em></p>")},drawScalebar:function(){a("#mapScale img").attr("src",a("#scalebar_url").val()).show()},showBadPoints:function(){var b=a("#bad_points").val();b&&(a("#badRecords").html(b),a("#badRecordsWarning").show())},showSpinner:function(){a(".mapper-loading-spinner").show()},hideSpinner:function(){a(".mapper-loading-spinner").hide()},showErrorMessage:function(b){b='<span class="mapper-message-error ui-corner-all ui-widget-content">'+b+"</span>";
a("#mapOutput").append(b)},hideErrorMessage:function(){a("#mapOutput .mapper-message-error").remove()},showMap:function(b){var c=(new Date).getTime(),d="",e={};this.destroyJcrop();a("#output").val("pnga");a("#badRecordsWarning").hide();a("#download_token").val(c);this.showSpinner();d=a("form").serialize();e=a("form").serializeJSON();this.postData(d,b);a.jStorage.set("do-"+c.toString(),e);this.toggleUndo(!0)},postData:function(b,c){var d=this;d.hideErrorMessage();a.ajax({type:"POST",url:d.settings.baseUrl+
"/application/",data:b,dataType:"json",timeout:3E4,success:function(a){d.resetFormValues(a);d.resetJbbox();d.drawMap(a,c);d.drawLegend();d.drawScalebar();d.showBadPoints();d.addBadRecordsViewer()},error:function(b,c,g){"timeout"===c&&(d.showErrorMessage(a("#mapper-loading-error-message").text()),d.hideSpinner())}})},resetFormValues:function(b){a("#mapOutput input").each(function(){a(this).val("")});a.each("rendered_bbox rendered_rotation rendered_projection legend_url scalebar_url bad_points".split(" "),
function(){a("#"+this).val(b[this])});a("#bbox_map").val(a("#rendered_bbox").val());a("#projection_map").val(a("#rendered_projection").val());a("#rotation").val(a("#rendered_rotation").val());a("#pan").val("")},drawMap:function(b,c){var d=this;a("#mapOutputImage").attr("width",b.size[0]).attr("height",b.size[1]).css({width:b.size[0]+"px",height:b.size[1]+"px"}).attr("src",b.mapOutputImage).one("load",function(){c||(c={map:{bbox_rubberband:""}});d.loadCropSettings(c);d.hideSpinner()})},addBadRecordsViewer:function(){var b=
this;a("#badRecordsViewer").dialog({autoOpen:!1,height:"200",width:"500",dialogClass:"ui-dialog-title-badRecordsViewer",position:[200,200],modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){a(this).dialog("destroy")}}]});a(".toolsBadRecords").click(function(c){c.preventDefault();b.addBadRecordsViewer();a("#badRecordsViewer").dialog("open")})},generateDownload:function(){var b=this,c=a("#file-name").val(),d=(new Date).getTime().toString(),e=
"",f="",g="png",c=c.replace(/[~$?*,:;{}\[\]\\ "'\/@#!%\^()<>.+=|`&]+/g,"_");a("#file-name").val(c);a('input[name="file_name"]').val(c);a('input[name="download_factor"]').val(a('input[name="download-factor"]:checked').val());g=a("input[name='download-filetype']:checked").val();b.setFormOptions();a("#download_token").val(d);a.each(["ui-dialog-buttonpane","download-dialog"],function(){a("."+this).hide()});a(".download-message").show();switch(g){case "pptx":a("#output").val("pptx");b.vars.jcropAPI?a("#crop").val(1):
b.resetJbbox();f=a("form").serialize();a("body").download("/pptx/"+b.getLanguage(),f,"post");a("#output").val("pnga");break;case "docx":a("#output").val("docx");b.vars.jcropAPI?a("#crop").val(1):b.resetJbbox();f=a("form").serialize();a("body").download("/docx/"+b.getLanguage(),f,"post");a("#output").val("pnga");break;case "kml":f=a("form").serialize();a("body").download("/kml/",f,"post");break;default:a("#download").val(1),a("#output").val(g),b.vars.jcropAPI?a("#crop").val(1):b.resetJbbox(),f=a("form").serialize(),
a("body").download("/application/",f,"post"),a("#download").val(""),a("#output").val("pnga")}b.vars.fileDownloadTimer=h.setInterval(function(){e=a.cookie("fileDownloadToken");e===d&&b.finishDownload()},1E3);b.trackEvent("download",g)},setFormOptions:function(){a.each(["border","legend","scalebar","scalelinethickness"],function(){a("#"+this).prop("checked")?a('input[name="options['+this+']"]').val(1):a('input[name="options['+this+']"]').val("")})},finishDownload:function(){a(".download-message").hide();
a.each(["download-dialog","ui-dialog-buttonpane"],function(){a("."+this).show()});h.clearInterval(this.vars.fileDownloadTimer);a.cookie("fileDownloadToken",null)},showExamples:function(){a("#mapper-message-help").html('<img src="public/images/help-data.png" alt="" />').dialog({height:"355",width:"525",dialogClass:"ui-dialog-title-mapper-message-help",autoOpen:!0,modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){a(this).dialog("destroy")}}]}).show()},
showCodes:function(){var b=this.getParameterByName("locale")?{locale:this.getParameterByName("locale")}:{};a("#mapper-message-codes").dialog({height:"450",width:"850",dialogClass:"ui-dialog-title-mapper-message-codes",autoOpen:!0,modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){a(this).dialog("destroy")}}]}).show();this.loadCodes(a("#mapper-message-codes"),b)},loadCodes:function(b,c){var d=this,e="";b.find("tbody tr td").text("\u00a0");b.find("tbody tr td:first").text("\u00a0\u00a0\u00a0").addClass("loading");
a.ajax({type:"GET",url:d.settings.baseUrl+"/places/",data:c,dataType:"html",success:function(a){b.html(a);e=b.find(".filter-countries");e.val("");void 0!==c.filter&&e.val(c.filter);e.keypress(function(a){var f=a.keyCode||a.which;if(13===f||9===f)a.preventDefault(),c.filter=e.val(),d.loadCodes(b,c)});e.blur(function(){c.filter=e.val();d.loadCodes(b,c)})}})},performRotation:function(b){a("#rotation").val(a(b).attr("data-rotate"));this.resetJbbox();this.destroyRedo();this.showMap();this.trackEvent("rotate",
a(b).attr("data-rotate"))},setRotation:function(b){var c=a("#mapControls"),d=a(".thumb",c),e=a(".overview",c).children(),f=0,g=f=0;b||(b=0);b=0>parseFloat(b)?parseFloat(b)+360:parseFloat(b);f=b*(Math.PI/180);a(".overview",c).css({left:-(b/360*e.outerWidth(!0)*e.length)+"px"});g=Math.round(28*-Math.cos(f)+(c.outerHeight()/2-d.outerHeight()/2))+"px";f=Math.round(28*Math.sin(f)+(c.outerWidth()/2-d.outerWidth()/2))+"px";a(".thumb",c).css({top:g,left:f})},getParameterByName:function(a){a="[\\?&]"+a.replace(/[\[]/,
"\\[").replace(/[\]]/,"\\]")+"=([^&#]*)";a=RegExp(a).exec(h.location.href);return null===a?"":decodeURIComponent(a[1].replace(/\+/g," "))},mapCircleSlider:function(){for(var a=0,c="",a=0;360>a;a+=1)0===a%5&&(c+='<li data-rotate="'+a+'"></li>');return c},clearStorage:function(){this.destroyRedo();a.jStorage.flush()},bindStorage:function(){var b={},c=(new Date).getTime();this.clearStorage();b=a("form").serializeJSON();a.jStorage.set("do-"+c.toString(),b)},bindRotateWheel:function(){var b=this;a(".overlay",
"#mapControls").css({backgroundImage:'url("public/images/bg-rotatescroll.png")'});a(".overview","#mapControls").append(b.mapCircleSlider());a("#mapControls").tinycircleslider({snaptodots:!0,radius:28,callback:function(c,d){a(".mapper-loading-spinner").is(":hidden")&&b.performRotation(c)}})},bindTabs:function(){var b=a("#tabs"),c="";a("#mapTools").tabs({selected:0});b.tabs({cache:!0,load:function(b,c){a(c.tab).data("cache.tabs",""===a(c.panel).html()?!1:!0)},event:"change"}).find(".ui-state-disabled").each(function(){a(this).removeClass("ui-state-disabled")}).end().show();
b.find("ul.navigation a").click(function(){var b={},e=a(this).parent().prevAll().length;b.tabs=e;a.bbq.pushState(b);a.each(a("#site-languages a"),function(){c=a(this).attr("href").split("#")[0];a(this).attr("href",c+"#tabs="+e)})});a(h).bind("hashchange",function(d){var e=a.bbq.getState("tabs",!0)||0;b.find("ul.navigation a").eq(e).triggerHandler("change");a.each(a("#site-languages a"),function(){c=a(this).attr("href").split("#")[0];a(this).attr("href",c+"#tabs="+e)})});a(h).trigger("hashchange")},
screenSizeListener:function(){var b=this;a(h).resize(function(){var c=b.getPageSize(),d=b.getPageScroll();a("#mapper-overlay").css({width:c[0],height:c[1]});a("#mapper-message").css({top:d[1]+c[3]/10,left:d[0],position:"fixed",zIndex:1001,margin:"0px auto",width:"100%"})})},init:function(){var b=this;this.screenSizeListener();this.bindRotateWheel();this.hideSpinner();a("#header>div").show();this.bindTabs();a("#mapOutput").append('<img id="mapOutputImage" src="public/images/basemap.png" alt="" width="800" height="400" />').find("span.mapper-loading-message").remove();
a("#mapScale").append('<img id="mapOutputScale" src="public/images/basemap-scalebar.png" width="200" height="27" />');a("a.login","#site-session").click(function(a){a.preventDefault();b.tabSelector(3)});a("a.show-examples").click(function(a){a.preventDefault();b.showExamples()});a("a.show-codes").click(function(a){a.preventDefault();b.showCodes()});a(".fieldSets").accordion({header:"h3",collapsible:!0,autoHeight:!1});a(".tooltip").tipsy({gravity:"s"});this.bindStorage();this.bindHotkeys();this.bindToolbar();
this.bindArrows();this.bindSettings();this.bindSlider();this.bindColorPickers();this.bindAddButtons();this.bindClearButtons();this.bindAutocomplete();this.bindSave();this.bindDownload();this.bindSubmit();this.bindPanelToggle();a(".toolsUndoDisabled").click(!1);a(".toolsRedoDisabled").click(!1);a("textarea.resizable:not(.textarea-processed)").TextAreaResizer();0<a("#usermaps").length&&(this.loadMapList(),this.tabSelector(3));0<a("#userdata").length&&(this.loadUserList(),this.tabSelector(4));a("input").keypress(function(a){if(13===
a.which)return!1})}};return{init:function(b){a.extend(n.settings,b);n.init()},getParameterByName:function(a){n.getParameterByName(a)},loadCodes:function(a,c){n.loadCodes(a,c)}}}(jQuery,window,document);
