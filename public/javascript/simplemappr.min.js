...
var SimpleMappr=function(a,h,g){'use strict';var n={settings:{baseUrl:"",active:!1,maxTextareaCount:10,undoSize:10},vars:{newPointCount:0,newRegionCount:0,zoom:!0,fileDownloadTimer:{},fillColor:"",jCropType:"zoom",cropUpdated:!1,origins:{"esri:102009":-96,"esri:102015":-60,"esri:102014":10,"esri:102012":105,"esri:102024":25,"epsg:3112":134}},trackEvent:function(a,c){void 0!==h._gaq&&_gaq.push(["_trackEvent",a,c])},getPageSize:function(){var a,c,d,e;h.innerHeight&&h.scrollMaxY?(a=h.innerWidth+h.scrollMaxX,c=h.innerHeight+
h.scrollMaxY):g.body.scrollHeight>g.body.offsetHeight?(a=g.body.scrollWidth,c=g.body.scrollHeight):(a=g.body.offsetWidth,c=g.body.offsetHeight);self.innerHeight?(d=g.documentElement.clientWidth?g.documentElement.clientWidth:self.innerWidth,e=self.innerHeight):g.documentElement&&g.documentElement.clientHeight?(d=g.documentElement.clientWidth,e=g.documentElement.clientHeight):g.body&&(d=g.body.clientWidth,e=g.body.clientHeight);return[a<d?a:d,c<e?e:c,d,e]},getPageScroll:function(){var a,c;self.pageYOffset?
(c=self.pageYOffset,a=self.pageXOffset):g.documentElement&&g.documentElement.scrollTop?(c=g.documentElement.scrollTop,a=g.documentElement.scrollLeft):g.body&&(c=g.body.scrollTop,a=g.body.scrollLeft);return[a,c]},showCoords:function(b){var c=this,d=parseFloat(b.x),e=parseFloat(b.y),f=parseFloat(b.x2),k=parseFloat(b.y2),l=parseFloat(b.w);b=parseFloat(b.h);var g={x:d,y:e},r={x:f,y:k},h={},m={},q=a('input[name="download-factor"]:checked').val();switch(this.vars.jCropType){case "crop":a(".jcrop-holder div:first").css({backgroundColor:"white"});
a("#bbox_rubberband").val(d+","+e+","+f+","+k);"epsg:4326"===a("#projection option:selected").val()?a(".jcrop-coord").css({width:"100px"}):a(".jcrop-coord").css({width:"175px"});0===a("#jcrop-coord-ul").length&&0===a("#jcrop-coord-lr").length&&a(".jcrop-tracker").eq(0).after('<input type="text" id="jcrop-coord-ul" class="jcrop-coord"></input>').after('<input type="text" id="jcrop-coord-lr" class="jcrop-coord"></input>').after('<div id="jcrop-dimension-wrapper"><input type="text" id="jcrop-dimension-w" class="jcrop-dimension"></input>X<input type="text" id="jcrop-dimension-h" class="jcrop-dimension"></input></div>');
...
a(this).hasClass("asc")&&(e.sort.dir="desc");c.loadMapList(e);c.trackEvent("maplist","sort")}),a(".map-load").click(function(a){a.preventDefault();c.loadMap(this);c.trackEvent("map","load")}),a(".map-delete").click(function(a){a.preventDefault();c.deleteMapConfirmation(this)}))}})},removeExtraElements:function(){a.each(a(".fieldset-points"),function(b){2<b&&a(this).remove()});a.each(a(".fieldset-regions"),function(b){2<b&&a(this).remove()});this.vars.newPointCount=0;this.vars.newRegionCount=0},prepareInputs:function(b){var c=
{},d=[],c={status:"ok",mid:a(".map-embed").attr("data-id"),map:b};c.map.coords=c.map.coords||[];c.map.regions=c.map.regions||[];c.map.layers=c.map.layers||{};c.map.options=c.map.options||{};String.prototype.clean=function(){return this.replace(/[\[\]]/g,"")};a.each(b,function(a,b){-1!==a.indexOf("coords")&&(d=a.match(/\[[A-Za-z0-9]*?\]/g))&&(void 0===c.map.coords[parseInt(d[0].clean(),10)]&&(c.map.coords[parseInt(d[0].clean(),10)]={}),c.map.coords[parseInt(d[0].clean(),10)][d[1].clean()]=b,delete c.map["coords"+
d[0]+d[1]]);-1!==a.indexOf("regions")&&(d=a.match(/\[[A-Za-z0-9]*?\]/g))&&(void 0===c.map.regions[parseInt(d[0].clean(),10)]&&(c.map.regions[parseInt(d[0].clean(),10)]={}),c.map.regions[parseInt(d[0].clean(),10)][d[1].clean()]=b,delete c.map["regions"+d[0]+d[1]]);-1!==a.indexOf("layers")&&(d=a.match(/\[[A-Za-z0-9]*?\]/g))&&(c.map.layers[d[0].clean()]=b,delete c.map["layers"+d[0]]);-1!==a.indexOf("options")&&(d=a.match(/\[[A-Za-z0-9]*?\]/g))&&(c.map.options[d[0].clean()]=b,delete c.map["options"+d[0]]);
"save[title]"===a&&(c.map.save={title:b},delete c.map["save[title]"]);"gridspace"===a&&(c.map.grid_space=b);"download-filetype"===a&&(c.map.download_filetype=b);"download-factor"===a&&(c.map.download_factor=b)});return c},loadInputs:function(b){var c=a("#filter-mymaps").val();this.removeExtraElements();a("#form-mapper").clearForm();a.each(["width","height"],function(){a('input[name="'+this+'"]').val(a('input[name="'+this+'"]').val())});a(".addmore").prop("disabled",!1);a("#filter-mymaps").val(c);
a("#origin-selector").hide();this.loadCoordinates(b);this.loadRegions(b);this.loadLayers(b);this.loadSettings(b)},loadMap:function(b){var c=this,d=a(b).attr("data-id");this.tabSelector(0);this.showSpinner();a.ajax({type:"GET",url:c.settings.baseUrl+"/usermap/"+d,dataType:"json",timeout:3E4,success:function(b){c.hideSpinner();"ok"===b.status?(c.loadInputs(b),c.showMap(b),c.bindStorage(),c.activateEmbed(d)):c.showErrorMessage(a("#mapper-loading-error-message").text());c.toggleUndo();c.toggleRedo()},
error:function(b,d,g){"timeout"===d&&c.showErrorMessage(a("#mapper-loading-error-message").text())}})},loadSettings:function(b){var c="",c="",c=b.map.save.title;a('input[name="save[title]"]').val(c);a(".m-mapSaveTitle").val(c);a("#mapTitle").text(c);c=c.replace(/[?*:;{}\\ "']+/g,"_");a("#file-name").val(c);a("#projection").val(b.map.projection);this.vars.origins.hasOwnProperty(a("#projection").val())&&a("#origin-selector").show();a.each(["bbox_map","projection_map","rotation","origin"],function(){a('input[name="'+
this+'"]').val(b.map[this])});b.map.origin||a("#origin").val(this.vars.origins[a("#projection").val()]);a('input[name="border_thickness"]').val(1.25);a("#border-slider").slider({value:1.25});void 0!==b.map.border_thickness&&b.map.border_thickness&&(a('input[name="border_thickness"]').val(b.map.border_thickness),a("#border-slider").slider({value:b.map.border_thickness}));this.setRotation(b.map.rotation);this.resetJbbox();a.each(["border","legend","scalebar","scalelinethickness"],function(){a("#"+this).prop("checked",
!1);a('input[name="options['+this+']"]').val("")});void 0!==b.map.options&&a.each(["border","legend","scalebar","scalelinethickness"],function(){b.map.options[this]&&void 0!==b.map.options[this]&&(a("#"+this).prop("checked",!0),a('input[name="options['+this+']"]').val(1))});void 0!==b.map.download_factor&&b.map.download_factor?(a('input[name="download_factor"]').val(b.map.download_factor),a("#download-factor-"+b.map.download_factor).prop("checked",!0)):a("#download-factor-3").prop("checked",!0);void 0!==
b.map.download_filetype&&b.map.download_filetype?(a('input[name="download_filetype"]').val(b.map.download_filetype),c=a("#download-"+b.map.download_filetype).prop("checked",!0),this.toggleFileType(c)):a("#download-svg").prop("checked",!0);void 0!==b.map.grid_space&&b.map.grid_space?(a('input[name="gridspace"]').prop("checked",!0),a("#gridspace-"+b.map.grid_space).prop("checked",!0)):a("#gridspace").prop("checked",!0);void 0!==b.map.gridlabel&&b.map.gridlabel?a('input[name="gridlabel"]').prop("checked",
!0).val("false"):a("#gridlabel").prop("checked",!0)},loadCropSettings:function(a){var c=[];a.map.bbox_rubberband?(c=a.map.bbox_rubberband.split(","),this.initJcrop([c[2],c[3],c[0],c[1]]),this.toggleFileFactor(a.map.download_factor)):this.destroyJcrop()},loadShapeSize:function(b,c){a.each(["shape","size"],function(){""===c[b][this].toString()?a('select[name="coords['+b.toString()+"]["+this+']"]')[0].selectedIndex=3:a('select[name="coords['+b.toString()+"]["+this+']"]').val(c[b][this])})},loadCoordinates:function(b){var c=
this,d=b.map.coords||[],e="",f="",g="",h=/[?*{}\\]+/g;a.each(d,function(b){2<b&&c.addAccordionPanel("coords");e=d[b].title||"";f=d[b].data.replace(h,"")||"";g=d[b].color||"0 0 0";a('input[name="coords['+b.toString()+'][title]"]').val(e);a('textarea[name="coords['+b.toString()+'][data]"]').val(f);c.loadShapeSize(b,d);a('input[name="coords['+b.toString()+'][color]"]').val(g)})},loadRegions:function(b){var c=this,d=b.map.regions||[],e="",f="",g="";a.each(d,function(b){2<b&&c.addAccordionPanel("regions");
e=d[b].title||"";f=d[b].data||"";g=d[b].color||"150 150 150";a('input[name="regions['+b.toString()+'][title]"]').val(e);a('textarea[name="regions['+b.toString()+'][data]"]').val(f);a('input[name="regions['+b.toString()+'][color]"]').val(g)})},loadLayers:function(b){b.map.layers&&a.each(b.map.layers,function(b,d){a('input[name="layers['+b+']"]').prop("checked",!0)})},activateEmbed:function(b){var c=this,d=["img","kml","svg","json"];a(".map-embed").attr("data-id",b).css({display:"block"}).click(function(e){e.preventDefault();
a.each(d,function(){"img"===this.toString()?a("#embed-"+this,"#mapEmbed").val('<img src="'+c.settings.baseUrl+"/map/"+b+'" alt="" />'):a("#embed-"+this,"#mapEmbed").val(c.settings.baseUrl+"/map/"+b+"."+this)});a("#mapEmbed").find("span.mid").text(b).end().dialog({width:"525",dialogClass:"ui-dialog-title-mapEmbed",autoOpen:!0,modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){a(this).dialog("destroy")}}]}).show()})},deleteMapConfirmation:function(b){var c=
this,d=a(b).attr("data-id");b="<em>"+a(b).parent().parent().find(".title").text()+"</em>";a("#mapper-message-delete").find("span").html(b).end().dialog({height:"250",width:"500",dialogClass:"ui-dialog-title-mapper-message-delete",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:a("#button-titles span.delete").text(),"class":"negative",click:function(){a.ajax({type:"DELETE",url:c.settings.baseUrl+"/usermap/"+d,success:function(){c.loadMapList();c.trackEvent("map","delete")}});a(this).dialog("destroy")}},
{text:a("#button-titles span.cancel").text(),"class":"ui-button-cancel",click:function(){a(this).dialog("destroy")}}]}).show()},loadUserList:function(b){var c=this;b=b||{};var d={locale:this.getParameterByName("locale")};c.showSpinner();b.sort&&(d.sort=b.sort.item,d.dir=b.sort.dir);d.locale||delete d.locale;a.ajax({type:"GET",url:c.settings.baseUrl+"/user/",data:d,dataType:"html",success:function(b){-1!==b.indexOf("access denied")?h.location.reload():(a("#userdata").html(b),c.hideSpinner(),a(".toolsRefresh",
".grid-users").click(function(a){a.preventDefault();c.loadUserList()}),a(".ui-icon-triangle-sort",".grid-users").click(function(b){b.preventDefault();d.sort={item:a(this).attr("data-sort"),dir:"asc"};a(this).hasClass("asc")&&(d.sort.dir="desc");c.loadUserList(d)}),a(".user-delete").click(function(a){a.preventDefault();c.deleteUserConfirmation(this)}),a(".user-load").click(function(b){b.preventDefault();c.loadMapList({uid:a(this).attr("data-uid")});c.tabSelector(3)}))}})},getLanguage:function(){var a=
"",c=this.getParameterByName("locale");if("fr_FR"===c||"es_ES"===c)a="?locale="+c;return a},deleteUserConfirmation:function(b){var c=this,d=a(b).attr("data-id");b="<em>"+a(b).parent().parent().children("td:first").text()+"</em>";a("#mapper-message-delete").find("span").html(b).end().dialog({height:"250",width:"500",dialogClass:"ui-dialog-title-mapper-message-delete",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:a("#button-titles span.delete").text(),"class":"negative",click:function(){a.ajax({type:"DELETE",
url:c.settings.baseUrl+"/user/"+d,success:function(){c.loadUserList();c.trackEvent("user","delete")}});a(this).dialog("destroy")}},{text:a("#button-titles span.cancel").text(),"class":"ui-button-cancel",click:function(){a(this).dialog("destroy")}}]}).show()},bindSave:function(){var b=this;a(".map-save").click(function(a){a.preventDefault();b.mapSave()})},mapSave:function(){var b=!1,c=/[?*:;{}\\ "'\/@#!%\^()<>.]+/g,d="",e=this;a("#mapSave").dialog({autoOpen:!0,height:"175",width:"350",dialogClass:"ui-dialog-title-mapSave",
modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:a("#button-titles span.save").text(),"class":"positive",click:function(){""===a.trim(a(".m-mapSaveTitle").val())&&(b=!0);b?a(".m-mapSaveTitle").addClass("ui-state-error").keyup(function(){a(this).removeClass("ui-state-error")}):(a('input[name="save[title]"]').val(a(".m-mapSaveTitle").val()),a.each(["factor","filetype"],function(){a('input[name="download_'+this+'"]').val(a('input[name="download-'+this+'"]:checked').val())}),a('input[name="grid_space"]').val(a('input[name="gridspace"]:checked').val()),
e.setFormOptions(),e.showSpinner(),void 0===e.vars.jcropAPI&&a("#bbox_rubberband").val(""),a.ajax({type:"POST",url:e.settings.baseUrl+"/usermap/",data:a("form").serialize(),dataType:"json",success:function(b){a("#mapTitle").text(a(".m-mapSaveTitle").val());d=a(".m-mapSaveTitle").val().replace(c,"_");a("#file-name").val(d);e.activateEmbed(b.mid);e.loadMapList();e.hideSpinner();e.trackEvent("map","save")}}),a(this).dialog("destroy"))}},{text:a("#button-titles span.cancel").text(),"class":"ui-button-cancel",
click:function(){a(this).dialog("destroy")}}]})},bindDownload:function(){var b=this;a(".map-download").click(function(a){a.preventDefault();b.mapDownload()})},mapDownload:function(){var b=this;a("#mapExport").dialog({autoOpen:!0,width:"620",dialogClass:"ui-dialog-title-mapExport",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:a("#button-titles span.download").text(),"class":"positive",click:function(){b.generateDownload()}},{text:a("#button-titles span.cancel").text(),"class":"ui-button-cancel",
click:function(){a(this).dialog("destroy")}}]})},bindSubmit:function(){var b=this,c="",d=!1;a(".submitForm").click(function(e){e.preventDefault();d=!1;a(".m-mapCoord").each(function(){c=a(this).parents(".ui-accordion-content").find(".m-mapTitle").keyup(function(){d=!1;a(this).removeClass("ui-state-error")});a(this).val()&&""===a(c).val()&&(d=!0,a(c).addClass("ui-state-error"))});d?b.showMessage(a("#mapper-missing-legend").text()):(b.destroyRedo(),b.showMap(),b.tabSelector(0))})},mapToggleSettings:function(){a("#mapToolsCollapse a").trigger("click")},
bindPanelToggle:function(){var b=this;a("#mapToolsCollapse a").tipsy({gravity:"e"}).toggleClick(function(c){c.preventDefault();a("#mapOutputImage").attr("width",0).attr("height",0).css({width:"0px",height:"0px"});a("#mapOutputScale").hide();a(this).parent().addClass("mapTools-collapsed");a("#mapTools").hide("slide",{direction:"right"},250,function(){var c=0.98*a(h).width();a("#actionsBar").animate({width:c},250);a("#map").animate({width:c},250,function(){a('input[name="width"]').val(c);b.mapRefresh()})})},
function(c){c.preventDefault();a("#mapOutputImage").attr("width",0).attr("height",0).css({width:"0px",height:"0px"});a("#mapOutputScale").hide();a(this).parent().removeClass("mapTools-collapsed");a("#mapTools").show("slide",{direction:"right"},250,function(){a("#actionsBar").animate({width:"810px"},250);a("#map").animate({width:"800px"},250,function(){a('input[name="width"]').val(800);b.mapRefresh()})})})},showMessage:function(b){a("#mapper-message").html(b).dialog({autoOpen:!0,height:"200",width:"400",
dialogClass:"ui-dialog-title-mapper-message",modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK","class":"positive",click:function(){a(this).dialog("destroy")}}]}).show()},drawLegend:function(){var b=a("#legend_url").val(),c=a("#mapLegend");b?c.html('<img src="'+b+'" />'):c.html("<p><em>"+a("#mapper-legend-message").text()+"</em></p>")},drawScalebar:function(){a("#mapScale img").attr("src",a("#scalebar_url").val()).show()},showBadPoints:function(){var b=a("#bad_points").val();
b&&(a("#badRecords").html(b),a("#badRecordsWarning").show())},showSpinner:function(){a(".mapper-loading-spinner").show()},hideSpinner:function(){a(".mapper-loading-spinner").hide()},showErrorMessage:function(b){b='<span class="mapper-message-error ui-corner-all ui-widget-content">'+b+"</span>";a("#mapOutput").append(b)},hideErrorMessage:function(){a("#mapOutput .mapper-message-error").remove()},showMap:function(b){var c=(new Date).getTime(),d="",e={};this.destroyJcrop();a("#output").val("pnga");a("#badRecordsWarning").hide();
a("#download_token").val(c);this.showSpinner();d=a("form").serialize();e=a("form").serializeJSON();this.postData(d,b);a.jStorage.set("do-"+c.toString(),e);this.toggleUndo(!0)},postData:function(b,c){var d=this;d.hideErrorMessage();a.ajax({type:"POST",url:d.settings.baseUrl+"/application/",data:b,dataType:"json",timeout:3E4,success:function(a){d.resetFormValues(a);d.resetJbbox();d.drawMap(a,c);d.drawLegend();d.drawScalebar();d.showBadPoints();d.addBadRecordsViewer()},error:function(b,c,g){"timeout"===
c&&(d.showErrorMessage(a("#mapper-loading-error-message").text()),d.hideSpinner())}})},resetFormValues:function(b){a("#mapOutput input").each(function(){a(this).val("")});a.each("rendered_bbox rendered_rotation rendered_projection legend_url scalebar_url bad_points".split(" "),function(){a("#"+this).val(b[this])});a("#bbox_map").val(a("#rendered_bbox").val());a("#projection_map").val(a("#rendered_projection").val());a("#rotation").val(a("#rendered_rotation").val());a("#pan").val("")},drawMap:function(b,
c){var d=this;a("#mapOutputImage").attr("width",b.size[0]).attr("height",b.size[1]).css({width:b.size[0]+"px",height:b.size[1]+"px"}).attr("src",b.mapOutputImage).one("load",function(){c||(c={map:{bbox_rubberband:""}});d.loadCropSettings(c);d.hideSpinner()})},addBadRecordsViewer:function(){var b=this;a("#badRecordsViewer").dialog({autoOpen:!1,height:"200",width:"500",dialogClass:"ui-dialog-title-badRecordsViewer",position:[200,200],modal:!0,closeOnEscape:!1,draggable:!0,resizable:!1,buttons:[{text:"OK",
"class":"positive",click:function(){a(this).dialog("destroy")}}]});a(".toolsBadRecords").click(function(c){c.preventDefault();b.addBadRecordsViewer();a("#badRecordsViewer").dialog("open")})},generateDownload:function(){var b=this,c=a("#file-name").val(),d=(new Date).getTime().toString(),e="",f="",g="png",c=c.replace(/[~$?*,:;{}\[\]\\ "'\/@#!%\^()<>.+=|`&]+/g,"_");a("#file-name").val(c);a('input[name="file_name"]').val(c);a('input[name="download_factor"]').val(a('input[name="download-factor"]:checked').val());
