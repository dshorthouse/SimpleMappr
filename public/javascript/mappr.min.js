...
b.destroyRedo();b.showLoadingMessage($("#mapper-loading-message").text());$.ajax({type:"POST",url:b.settings.baseUrl+"/query/",data:a,timeout:2E4,success:function(a){if(0<a.length){var f="",g=$(".fieldset-regions").length;for(c=0;c<a.length;c+=1)f+=a[c],c<a.length-1&&(f+=", ");for(c=0;c<g;c+=1)if(""===$('input[name="regions['+c+'][title]"]').val()||""===$('textarea[name="regions['+c+'][data]"]').val()){$('input[name="regions['+c+'][title]"]').val("Selected Region "+(c+1).toString());$('input[name="regions['+
c+'][color]"]').val(d);$('textarea[name="regions['+c+'][data]"]').val(f);c===g-1&&!$('button[data-type="regions"]').is(":disabled")&&b.addAccordionPanel("regions");break}else c===g-1&&(b.addAccordionPanel("regions"),g+=1);$("#fieldSetsRegions").accordion("activate",c);b.showMap()}else b.hideLoadingMessage()},error:function(a,c){"timeout"===c&&b.hideLoadingMessage()}})};Mappr.textareaCounter=function(a,b){switch(b){case "get":switch(a){case "coords":return this.vars.newPointCount;case "regions":return this.vars.newRegionCount}break;
case "increase":switch(a){case "coords":return this.vars.newPointCount+=1;case "regions":return this.vars.newRegionCount+=1}break;case "decrease":switch(a){case "coords":return this.vars.newPointCount-=1;case "regions":return this.vars.newRegionCount-=1}}};Mappr.addAccordionPanel=function(a){var b=this,c=b.textareaCounter(a,"get"),d=$(".addmore[data-type='"+a+"']"),e={},f="coords"===a?"0 0 0":"150 150 150",g=0,h=[];d.attr("data-type")===a&&(c<b.vars.maxTextareaCount&&(d.parent().prev().accordion("activate",
...
function(a){e=d.height()-a.pageY;d.css("opacity",0.25);$(document).bind("mousemove",b).bind("mouseup",c);return!1})};Mappr.bindAddButtons=function(){var a=this;$(".addmore").click(function(b){var c=$(this).attr("data-type"),d=0;b.preventDefault();a.addAccordionPanel(c);d=$(this).parent().prev().children().length;$(this).parent().prev().accordion("activate",d-1);return!1})};Mappr.loadMapList=function(a){var b=this,c=a||{},a=$(".usermaps-loading").clone(!0),d={};$("#usermaps").html("").append(a.show());
d={locale:b.getParameterByName("locale"),q:c.q?encodeURIComponent(c.q.toLowerCase()):null,uid:c.uid||null};c.sort&&(d.sort=c.sort.item,d.dir=c.sort.dir);d.locale||delete d.locale;d.q||delete d.q;d.uid||delete d.uid;$.ajax({type:"GET",url:b.settings.baseUrl+"/usermaps/",data:d,dataType:"html",success:function(a){if(a.indexOf("session timeout")!==-1)window.location.reload();else{$("#usermaps").find(".usermaps-loading").remove().end().html(a);$(".toolsRefresh",".grid-usermaps").click(function(a){a.preventDefault();
...
"class":"ui-button-cancel",click:function(){$(this).dialog("destroy")}}]}).show()};Mappr.loadUserList=function(a){var b=this,c=$(".userdata-loading").clone(!0),a=a||{},d={locale:this.getParameterByName("locale")};$("#userdata").html("").append(c.show());a.sort&&(d.sort=a.sort.item,d.dir=a.sort.dir);d.locale||delete d.locale;$.ajax({type:"GET",url:b.settings.baseUrl+"/users/",data:d,dataType:"html",success:function(a){if(a.indexOf("access denied")!==-1)window.location.reload();else{$("#userdata").find(".userdata-loading").remove().end().html(a);
$(".toolsRefresh",".grid-users").click(function(a){a.preventDefault();b.loadUserList()});$(".ui-icon-triangle-sort",".grid-users").click(function(a){a.preventDefault();d.sort={item:$(this).attr("data-sort"),dir:"asc"};if($(this).hasClass("asc"))d.sort.dir="desc";b.loadUserList(d)});$(".user-delete").click(function(a){a.preventDefault();b.deleteUserConfirmation(this)});$(".user-load").click(function(a){a.preventDefault();b.tabSelector(3);b.loadMapList({uid:$(this).attr("data-uid")})})}}})};Mappr.getLanguage=
