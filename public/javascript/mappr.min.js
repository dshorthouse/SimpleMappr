...
b.destroyRedo();b.showLoadingMessage($("#mapper-loading-message").text());$.ajax({type:"POST",url:b.settings.baseUrl+"/query/",data:a,timeout:1E4,success:function(a){if(0<a.length){var f="",g=$(".fieldset-regions").length;for(c=0;c<a.length;c+=1)f+=a[c],c<a.length-1&&(f+=", ");for(c=0;c<g;c+=1)if(""===$('input[name="regions['+c+'][title]"]').val()||""===$('textarea[name="regions['+c+'][data]"]').val()){$('input[name="regions['+c+'][title]"]').val("Selected Region "+(c+1).toString());$('input[name="regions['+
...
this.loadCoordinates(a);this.loadRegions(a);this.loadLayers(a);this.loadSettings(a)};Mappr.loadMap=function(a){var b=this,c=$(a).attr("data-mid");b.tabSelector(0);b.showLoadingMessage($("#mapper-loading-message").text());$.ajax({type:"GET",url:b.settings.baseUrl+"/usermaps/"+c,dataType:"json",timeout:1E4,success:function(a){b.hideLoadingMessage();"ok"===a.status?(b.loadInputs(a),b.showMap(a),b.bindStorage(),b.activateEmbed(c)):b.showErrorMessage($("#mapper-loading-error-message").text());b.toggleUndo();
...
$.ajax({type:"POST",url:d.settings.baseUrl+"/application/",data:a,dataType:"json",timeout:1E4,success:function(a){d.resetFormValues(a);d.resetJbbox();d.drawMap(a,b);d.drawLegend();d.drawScalebar();d.showBadPoints();d.addBadRecordsViewer()},error:function(a,b){"timeout"===b&&d.showErrorMessage($("#mapper-saving-error-message").text())}})};Mappr.resetFormValues=function(a){$("#mapOutput input").each(function(){$(this).val("")});$.each("rendered_bbox rendered_rotation rendered_projection legend_url scalebar_url bad_points".split(" "),
