  ...
  private function remote_js_files() {
    if(ENVIRONMENT == "production") {
      foreach(self::$local_js_files as $key => $value) {
        if ($value == 'public/javascript/jquery-1.7.1.min.js' || $value == 'public/javascript/jquery-ui-1.8.16.min.js') {
          unset(self::$local_js_files[$key]);
        }
      }
      $this->addJS("jquery", "http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js");
      $this->addJS("jquery-ui", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/jquery-ui.min.js");
    }
    return $this;
  }
