...
-->
    ...
    <form id="form-mapper" action="application/" method="post" autocomplete = "off">  
        ...
        <div id="map-about">
            ...
            <p class="update"><strong>September 29, 2011</strong><span>Crop corner coordinates are now stored in a cookie such that a crop selection is restored after refreshing, zooming, panning, or selecting different layers or options. However, changing the projection clears these stored coordinates.</span></p>
